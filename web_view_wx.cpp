...
namespace {
  ...
  struct WVSchemeHandler : public wxWebViewHandler {
    ...
    virtual wxFSFile *GetFile(const wxString &uri) {
      ...
      return new wxFSFile(new wxStringInputStream(os.str()), uri);
    }
  ...
  struct WVFrame : public wxFrame {
    ...
    void RegisterURIScheme(wxString &scheme, HandlerFunc *func) {
      if (!browser)
        return;
  ...
  struct WVApp : public wxApp {
    ...
    void OnNewWebView(wxThreadEvent& event) {
      ...
      WebFrame *frame = new WVFrame(d->label);
      frame->Show();
  ...
  struct web_view_wx_EXPORT impl_wx : public impl {
    impl_wx(const std::string &title) {
      ...
      if (!WVThread) {
        ...
        WVThreadCV.wait(iul, []{ return InitDone; } );
      }
